...
const Highlights = () => {
    const Highlts=[{icons:<AiOutlineNotification/>,name:"Notice",descriptions:"Lorem ipsum dolor sit amet, consectetur adipisicing elit." ,path:""},{icons:<FaBlog/>,name:"Blogs",path:"",descriptions:"Lorem ipsum dolor sit amet, consectetur adipisicing elit."},{icons:<GrWorkshop/>,name:"Clubs & Workshop",path:"",descriptions:"Lorem ipsum dolor sit amet, consectetur adipisicing elit."}]
  return (
